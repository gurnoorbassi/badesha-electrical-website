...
export default function ProjectsPage() {
  ...
  const residential = projects.filter((project) => !project.type.toLowerCase().includes("industrial"));
  ...
  return <main><PageIntro eyebrow="Project portfolio" title="Powering communities across B.C."><p>A selection of multi-family, townhouse, rental and industrial projects completed or underway across the Lower Mainland.</p></PageIntro>
    <nav className="page-tabs" aria-label="Project categories"><a href="#upcoming">Upcoming</a><a href="#completed">Completed</a><a href="#residential">Residential &amp; multi-family</a><a href="#commercial">Commercial &amp; industrial</a></nav>
