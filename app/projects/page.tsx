...
export default function ProjectsPage() {
  ...
  return <main><PageIntro eyebrow="Project portfolio" title="Powering communities across B.C."><p>A selection of multi-family, townhouse, rental and industrial projects completed or underway across the Lower Mainland.</p></PageIntro>
    <nav className="page-tabs" aria-label="Project categories"><a href="#upcoming">Upcoming</a><a href="#completed">Completed</a><a href="#residential">Residential &amp; multi-family</a><a href="#commercial">Commercial &amp; industrial</a><a href="#hospitality">Hospitality</a></nav>
    ...
    <section className="portfolio-categories"><article id="residential"><span>01</span><p>Residential &amp; multi-family</p><strong>{residential.length} projects</strong><a href="#upcoming">Explore portfolio</a></article><article id="commercial"><span>02</span><p>Commercial &amp; industrial</p><strong>{commercial.length} project</strong><a href="#completed">Explore portfolio</a></article><article id="hospitality"><span>03</span><p>Hospitality</p><strong>{hospitality.length} project</strong><Link href="/projects/four-points-victoria-gateway">View hotel project</Link></article></section>
