...
export default function AboutPage() {
  return <main><PageIntro eyebrow="About Badesha" title="Pride in the work. Respect for the people."><p>Badesha Electrical Ltd. is a Surrey-based electrical contractor serving residential, commercial and industrial clients across Greater Vancouver.</p></PageIntro>
    ...
    <section className="reviews-block" id="reviews"><div><p className="kicker light">Google reviews</p><h2>What our clients say.</h2><div className="review-rating"><strong>5.0 / 5</strong><span>Based on 6 Google reviews</span></div><a className="review-source" href={googleReviewsUrl} target="_blank" rel="noopener noreferrer">View all reviews on Google</a></div><blockquote><p>Amazing work, did the electrical scope on my rental building and couldn&apos;t think of anyone else to do it better.</p><cite>Gurbaj Gill · Google review</cite></blockquote><blockquote><p>Best rates, best service, friendly staff.</p><cite>J S Badesha · Google review</cite></blockquote><blockquote><p>Good job.</p><cite>Balkar Singh · Google review</cite></blockquote></section>
