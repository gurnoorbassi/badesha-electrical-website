...
export const metadata = pageMetadata({ title: "About Badesha Electrical", description: "Meet Badesha Electrical, a licensed and insured Surrey electrical contractor with more than 30 years of residential and commercial experience.", path: "/about", image: "/images/about.jpg" });
