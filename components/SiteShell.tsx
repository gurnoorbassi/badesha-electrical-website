  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-grid">
        <div>
          <Link className="footer-brand" href="/" aria-label="Badesha Electrical Ltd. home"><Image className="footer-logo" src="/images/logo-footer.png" alt="Badesha Electrical Ltd." width={2170} height={725} /></Link>
